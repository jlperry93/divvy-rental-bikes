...
export default class MiddleWare {
  ...
  public idHandler = async (req: Request, res: Response, next: NextFunction) => {
    if (!req.params.id) {
  ...
  public dateHandler = async (req: Request, res: Response, next: NextFunction) => {
    if (!req.params.date) {
  ...
  public cacheHandler = async (req: Request, res: Response, next: NextFunction) => {
    const key = req.url;
    if (this.cache[key]) {
